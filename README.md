...
We aim to generalize the "Overall" rating influenced by the "Wage" of a player. By comparing the datasets (e.g., `fifa.csv` and `players_18.csv`), we calculate the differences in `Wage` and `Overall` ratings. 
